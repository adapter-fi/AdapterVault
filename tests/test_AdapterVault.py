...
def test_initial_adapters_initialization(project, deployer, dai, adapter_adapterA, adapter_adapterB, adapter_adapterC, funds_alloc):
    ...
    adapter_vault = deployer.deploy(project.AdapterVault, d4626_name, d4626_token, d4626_decimals, dai, deployer, funds_alloc, "2.0")
...
def test_single_getBalanceTxs(project, deployer, adaptervault, adapter_adapterA, dai, trader, funds_alloc):
    ...
    d4626_delta, tx_count, adapters, blocked_adapters = funds_alloc.getTargetBalances(current_local_asset_balance, 0, total_assets, total_ratios, adapters, 0)
    ...
    d4626_delta, tx_count, adapters, blocked_adapters = funds_alloc.getTargetBalances(current_local_asset_balance, 250, total_assets, total_ratios, adapters, 0)
...
def test_single_adapter_brakes_target_balance_txs(project, deployer, adaptervault, adapter_adapterA, adapter_adapterB, adapter_adapterC, dai, trader, funds_alloc):
    ...
    current_local_asset_balance = dai.balanceOf(adaptervault)
    moved, tx_count, adapter_txs, blocked_adapters = funds_alloc.getTargetBalances(current_local_asset_balance, 0, 2000, 1, adapters, 0)    
